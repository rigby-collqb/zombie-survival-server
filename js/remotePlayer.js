...
class RemotePlayer{
  constructor(data){
    ...
    this._player.direction=data.direction||'down';this._player.health=data.health??100;this._player.maxHealth=data.maxHealth??100;this._player.alive=data.alive??true;
    this._player.aimDirX=data.aimDirX??0;this._player.aimDirY=data.aimDirY??1;this._player.currentWeapon=data.weaponId||'pistol';
  ...
  applySnapshot(data){
    ...
    this._player.direction=data.direction||this._player.direction;this._player.health=data.health??this._player.health;this._player.maxHealth=data.maxHealth??this._player.maxHealth;this._player.alive=data.alive??this._player.alive;
    this._player.aimDirX=data.aimDirX??this._player.aimDirX;this._player.aimDirY=data.aimDirY??this._player.aimDirY;this._player.name=data.name||this._player.name;if(data.weaponId)this._player.currentWeapon=data.weaponId;
  }
  interpolate(dt){
